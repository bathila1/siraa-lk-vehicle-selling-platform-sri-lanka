...
export function VehicleCard({ vehicle }: VehicleCardProps) {
  ...
  return (
    <Link
      ...
      className="group block bg-white rounded-xl overflow-hidden border border-[var(--color-border)] hover:border-[var(--brand-green)] hover:shadow-md transition-all duration-200"
    >
      {/* Image */}
      <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden">
        {vehicle.primary_image ? (
          <Image
            ...
            loading="lazy"
            className="object-cover group-hover:scale-105 transition-transform duration-300 fade-in"
          />
        ) : (
      ...
      <div className="p-3">
        {/* Title */}
        <h3 className="font-semibold text-[var(--brand-black)] text-sm leading-tight mb-1 truncate">
          {vehicle.year} {vehicle.make_name} {vehicle.model}
        </h3>

        {/* Price */}
        <p className="text-[var(--brand-deep)] font-bold text-base mb-2">
